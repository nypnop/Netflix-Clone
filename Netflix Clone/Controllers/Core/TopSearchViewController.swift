...
extension TopSearchViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = TitleViewModel(titleName: title.original_name ?? title.original_title ?? "Title Unknown", posterURL: title.poster_path ?? "")
...
//        vc.configure(with: TitlePreviewViewModel(movie_id: title.id, backdrop_path: title.backdrop_path))
...
extension TopSearchViewController: UISearchResultsUpdating, SearchResultViewControllerDelegate {
